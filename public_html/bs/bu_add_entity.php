                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <?php BreadCrumb($page_name, $parent = array('title' => 'Manage Entities', 'url' => 'bu_manage_entities.php')); ?>
                            </div>
                        </div>
                    </div>
                    <!-- /.container-fluid -->
                                ...
                                <div class="card w-50 mx-auto">
                                    ...
                                    <form id="add-entity" class="add-form" method="post" enctype="multipart/form-data" role="form">
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a class="btn btn-secondary float-end" href="bu_manage_entities.php">Cancel</a>
                                        </div>
                                    </form>
                                </div>    <!-- /.card -->
                            </div>    <!-- /.col -->
