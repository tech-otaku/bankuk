    ...
    $("div#update-accounting-period-modal").on("show.bs.modal", function (e) {
        ...
        */ 
        ...
        .done(function( dataReturnedByServer, textStatus, jqXHR) {  // Used instead of the AJAX local callback event 'success: function()'. See https://stackoverflow.com/a/15821199/2518495
            ...
            // Start
                $(e.currentTarget).find('form#update-accounting-period #period-start').datepicker({
                    beforeShow: function (
                ...
                $(e.currentTarget).find('form#update-accounting-period #period-start').datepicker("setDate", data['period_start']);
            // End
                $(e.currentTarget).find('form#update-accounting-period #period-end').datepicker({
                    beforeShow: function (
                        element,    // Represents the input field `div#datepicker` 
                        instance    // A JQuery object representing the current datepicker instance `div#ui-datepicker-div`
                    ) {
                ...
                $(e.currentTarget).find('form#update-accounting-period #period-end').datepicker("setDate", data['period_end']);
            // Accounting Period
