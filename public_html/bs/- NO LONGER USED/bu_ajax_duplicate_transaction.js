...
// Update
    $("a.duplicate_transaction").click(function() {      // Any anchor whose class is 'add-current-due-date' will be processed by this event handler when it's clicked
        ...
        Swal.fire({
            ...
            //html: "Are you sure you want to duplicate the <span class=\"text-grey\">" + recordType + "</span> record for <span class=\"text-grey\">" + recordIdentifier + "</span>?",
            html: "Are you sure you want to duplicate this record?",
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    url: "ajax/bu_ajax_duplicate_transaction.php",
                ...
                Swal.fire("Duplication Request Cancelled", "The record has not been duplicated", "info");
            }   // isConfirmed
        });
    });
});