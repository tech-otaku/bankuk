        ...
        <script>
            $(function() {
                        ...
                        todayTotal = api
                            ...
                            // rowSelector parameter
                                function ( idx, data, node ) {
                                    //console.log(data)
                                    if (Chronology(data['8']) != 'future') {    // data['8'] is the transaction's effective date. Chronology returns, 'past', 'today' or 'future'.
                                        return true
                                    } else {
                                        return false
                                    }                          
                ...
                function createDropdowns(api) {
                    api.columns([1,2,3,4,5,6,8,9],).every(function () {
                        //if (this.searchable()) {
                            var that = this;
                            var column = this;
