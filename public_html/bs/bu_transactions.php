                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-primary btn-sm view-record" href="#" data-bs-toggle="modal" data-bs-target="#update-transaction-modal" data-mysql-table="bu_transactions" data-record-id="<?php echo $row->id; ?>">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    
                                                    <!--
                                                    <a class="btn btn-primary btn-sm view-record" href="#" data-mysql-table="bu_transactions" data-record-id="<?php echo $row->id; ?>">
        ...
        <div class="modal fade" id="update-transaction-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <!-- Inject the transaction update form -->
                        <?php include("forms/form_update_transaction.php"); ?>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <!-- <button type="submit" class="btn btn-primary" form="update-transaction">Update</button> -->
                    </div>
                </div>
            </div>
        </div>
