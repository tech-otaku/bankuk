...
// Add
    $('form.add-form').on('submit', function(event) {                    // Any form whose class is 'add-form' will be processed by this event handler when it's submitted
