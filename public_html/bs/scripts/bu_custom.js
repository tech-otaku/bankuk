...
$(document).ready(function() {
    ...
    $("table.bu-data-table").on("click", ".has-note", function(event) {
        ...
        Swal.fire(
            {
                //title: "Note",
                html: '<div class="text-left">[<span class="text-grey">' + $(this).data("counter") + '</span>]&nbsp;<span class="text-grey">' + $(this).data("amount") + '</span>' + direction + '<span class="text-grey">' + $(this).data("entity-description") + '</span> on <span class="text-grey">' + $(this).data("date") + '</span><br /><br /><i>' + $(this).data("note") + '</></div>',
                icon: "info",
                position: "top-end"
            }
        );
